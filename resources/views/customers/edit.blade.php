...
<div class="container py-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold" style="color: #212529;">Edit Customer</h4>
    ...
    <div class="card border-0 shadow-sm" style="background-color: white; border-radius: 16px; overflow: hidden;">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('customers.update', $customer->id) }}">
                ...
                <div class="mb-4">
                    <label class="form-label text-muted small fw-semibold mb-2">Customer Name</label>
                    <div class="input-group">
                        ...
                        <input type="text" name="name" class="form-control border-0 bg-light" value="{{ $customer->name }}" required style="padding: 0.75rem 1rem; border-radius: 0 12px 12px 0;" placeholder="Enter customer name">
                    </div>
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" class="form-control border-0 bg-light" value="{{ $customer->phone }}" style="padding: 0.75rem 1rem; border-radius: 0 12px 12px 0;" placeholder="Enter phone number">
                    </div>
                    @error('phone')
                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <textarea name="address" class="form-control border-0 bg-light" rows="3" style="padding: 0.75rem 1rem; border-radius: 0 12px 12px 0;" placeholder="Enter address">{{ $customer->address }}</textarea>
                    </div>
                    @error('address')
                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                    @enderror
