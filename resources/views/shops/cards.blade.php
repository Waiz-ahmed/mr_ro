...
<div class="container py-4">
    ...
    @if(session('success'))
        <div class="alert alert-success alert-dismissible fade show" role="alert" style="background-color: #d4edda; color: #155724; border: none;">
            {{ session('success') }}
    ...
    <div class="row g-4">
        @forelse($shops as $shop)
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm" style="background-color: white; border-radius: 12px; transition: transform 0.2s, box-shadow 0.2s;">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <h5 class="card-title fw-semibold mb-0" style="color: #212529;">{{ $shop->name }}</h5>
                            <span class="badge" style="background-color: #e7f1ff; color: #0d6efd; font-size: 0.75rem; padding: 0.35rem 0.65rem; border-radius: 20px;">Shop</span>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3 pt-3" style="border-top: 1px solid #f1f1f1;">
                            ...
                            <a href="{{ route('shops.pos', $shop->id) }}" style="text-decoration: none;">
                                <button class="btn btn-sm" style="background-color: #0d6efd; color: white; border: none; border-radius: 8px; padding: 0.5rem 1.2rem; font-weight: 500; transition: background-color 0.2s;">
        ...
        @empty
            <div class="col-12">
                <div class="text-center py-5" style="background-color: white; border-radius: 12px; border: 1px dashed #dee2e6;">
...
<div class="modal fade" id="addShopModal" tabindex="-1" aria-labelledby="addShopModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form action="{{ route('shops.cards.store') }}" method="POST" class="modal-content border-0" style="border-radius: 16px;">
            @csrf
            ...
            <div class="modal-footer border-0 pt-0" style="background-color: white;">
                <button type="button" class="btn" data-bs-dismiss="modal" style="background-color: #f8f9fa; color: #495057; border: none; border-radius: 10px; padding: 0.6rem 1.5rem;">Cancel</button>
                <button type="submit" class="btn" style="background-color: #0d6efd; color: white; border: none; border-radius: 10px; padding: 0.6rem 1.5rem; font-weight: 500;">
